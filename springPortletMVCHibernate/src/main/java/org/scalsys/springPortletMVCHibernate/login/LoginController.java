...
public class LoginController {
	...
	@ActionMapping(params = {"action=userCreateEditAction"})
	public void userCreateOrEdit(@ModelAttribute User user,ActionRequest actionRequest,ActionResponse actionResponse) {
		System.out.println("In user creation or edit method");
